        ...
        <div className="flex items-center pl-1 relative w-full sm:ml-0 sm:pr-2 lg:max-w-68">
          ...
          <div className="container flex left-0 relative w-3/4">
            <div className="group hidden items-center ml-8 relative w-full md:flex lg:w-72">
              ...
              <svg
                className="absolute fill-current h-4 hidden left-0 ml-4 pointer-events-none text-gray-600 w-4 group-hover:global-text-1 sm:block"
              ...
              <input
                type="text"
                className="globalmainbg-color block leading-normal pl-10 py-1.5 pr-4 ring-opacity-90 rounded-2xl global-text-1 w-full focus:border-transparent focus:outline-none focus:ring-2 focus:ring-blue-500"
                placeholder="Search"
              />
            </div>
          </div>
