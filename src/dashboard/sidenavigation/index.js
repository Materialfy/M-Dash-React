...
//tailwind CSS variables that are used to style sidebar
const style = {
  mobilePosition: {
    left: 'left-0 ',
  ...
  default: `h-screen overflow-y-auto text-white top-0 lg:absolute globalbackground-color lg:block lg:z-40`,
};

export default function SideNavigation({ mobilePosition }) {
  // the context is consumed and destructed into open(useState) and ref(useRef) hooks
